...
return static function (ECSConfig $ecsConfig): void {
    ...
    $ecsConfig->ruleWithConfiguration(PhpCsFixer\Fixer\Phpdoc\NoSuperfluousPhpdocTagsFixer::class, ['remove_inheritdoc' => true]);
    ...
    $ecsConfig->ruleWithConfiguration(PhpCsFixer\Fixer\ConstantNotation\NativeConstantInvocationFixer::class, ['strict' => false]);
